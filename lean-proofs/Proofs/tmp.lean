...
theorem odd_sum_even: ∀ x y, odd x -> odd y -> even (x + y) := by
  ...
  unfold odd at h1 -- Expand the definition of odd for x, i.e., x = 2k1 + 1 for some integer k1
  unfold odd at h2 -- Expand the definition of odd for y, i.e., y = 2k2 + 1 for some integer k2
  cases h1 with -- Extract the specific integer k1 such that x = 2k1 + 1
  | intro k1 hk1 =>
    cases h2 with -- Extract the specific integer k2 such that y = 2k2 + 1
    | intro k2 hk2 =>
